...
public class TeamSelectionPanel : MonoBehaviour
{
    ...
    {
        if (MatchInfo.instance.leftTeam == null)
        {
            //Set info needed for Match scene
            MatchInfo.instance.leftTeam = btnInfo.teamInfo;
            MatchInfo.instance.leftTeamLineUp.defense = btnInfo.teamInfo.teamFormation.defense;
            MatchInfo.instance.leftTeamLineUp.mid = btnInfo.teamInfo.teamFormation.mid;
            MatchInfo.instance.leftTeamLineUp.attack = btnInfo.teamInfo.teamFormation.attack;
            MatchInfo.instance.leftTeamUniform = "Local";
            ...
            QuickMatchUIController.instance.SwitchUIControls();
        }
        else
        {
            //Set info needed for Match scene
            MatchInfo.instance.rightTeam = btnInfo.teamInfo;
            MatchInfo.instance.rightTeamLineUp.defense = btnInfo.teamInfo.teamFormation.defense;
            MatchInfo.instance.rightTeamLineUp.mid = btnInfo.teamInfo.teamFormation.mid;
            MatchInfo.instance.rightTeamLineUp.attack = btnInfo.teamInfo.teamFormation.attack;
            MatchInfo.instance.rightTeamUniform = "Local";
            QuickMatchUIController.instance.SwitchUIControls();
        }
    }
}
